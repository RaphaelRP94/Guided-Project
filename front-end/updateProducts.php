...
<body>
    ...
    <header id="cabecalho">
        ...
        <form method="post" action="updateProductsProcess.php">
    ...
    <script>
    //I am storing the items from the cart in the local storage from the browser.
    //So I am taking what is saved with the code bellow
    //I splited the array of objects into arrays of strings and then in one big string so I could manipulate them in the next steps. 
