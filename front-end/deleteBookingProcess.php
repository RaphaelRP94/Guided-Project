...
$sqlremoveBooking = "DELETE FROM bookings WHERE bookings.vplate = '$vplate' AND bookings.booking_status != 'collected'";
    ...
    <header id="cabecalho">
        ...
        <h2 id="secpart">brand new again</h2>
            ...
            <ul type="disc">
                ...
                <li onmouseover="mudaFoto('_imagens/especificacoes.png')" onmouseout="mudaFoto('_imagens/carmain.png')"><a href="specs.php">VEHICLE PARTS</a></li>
