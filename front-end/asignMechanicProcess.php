...
$sqlUpdateMechanic = "UPDATE bookings SET mechanic = '$mechanic' WHERE booking_id = '$localBookingID'";
$update = mysqli_query($connection, $sqlUpdateMechanic);
...
<body>
    <div id="interface">
        ...
        <h2>Mechanic set successfully</h2>
        <footer id="foot">
